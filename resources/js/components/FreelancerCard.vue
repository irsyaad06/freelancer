    ...
    <div class="w-50 max-w-xs mx-auto mt-10 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center p-6">
            ...
            <div class="flex items-center mb-2">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-400">{{ freelancer.rating }}</span>
                <span class="text-sm text-gray-500 dark:text-gray-400 ml-2">• {{ freelancer.is_verified }}</span>
            </div>

            <span class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Mulai Dari
                <span class="text-green-600 font-semibold">Rp {{ freelancer.price }}</span>
            </span>
